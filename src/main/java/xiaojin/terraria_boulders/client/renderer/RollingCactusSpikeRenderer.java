package xiaojin.terraria_boulders.client.renderer;
...
import xiaojin.terraria_boulders.common.entity.boulder.RollingCactusBoulderEntity;

public class RollingCactusSpikeRenderer extends EntityRenderer<RollingCactusBoulderEntity.SpikeProjectile> {
    private static final ResourceLocation TEXTURE = TerrariaBoulders.modRl("textures/entity/rolling_cactus_spike.png");
