package xiaojin.terraria_boulders.common.item;
...
import xiaojin.terraria_boulders.util.Consumer3;
...
public class BaseFoodItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity livingEntity) {
        if ( level instanceof ServerLevel serverLevel && level.random.nextFloat() < 0.7F) {
