...
import xiaojin.terraria_boulders.util.MultiplyExplosionDamageCalculator;
import xiaojin.terraria_boulders.util.TerraStyleExplosion;
...
public class LavaBoulderEntity extends BoulderEntity {
    ...
    public LavaBoulderEntity(Level level, Vec3 pos, BlockState blockState) {
        super(ModEntityTypes.LAVA_BOULDER.get(), level, pos, blockState);
    }
