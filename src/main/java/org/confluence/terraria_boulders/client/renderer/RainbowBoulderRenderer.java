...
import org.confluence.terraria_boulders.common.entity.boulder.RainbowBoulderEntity;

public class RainbowBoulderRenderer extends AbstractBoulderRenderer<RainbowBoulderEntity, RainbowBoulderRenderer.RainbowBoulderRenderState> {
    public RainbowBoulderRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    @Override
    public RainbowBoulderRenderState createRenderState() {
        return new RainbowBoulderRenderState();
    }
//
//    @Override
//    public void submit(RainbowBoulderRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera) {
...
//    }
    ...
    public static class RainbowBoulderRenderState extends BoulderRenderState {
    }
}
